...
export class InitSchema1762266831614 implements MigrationInterface {
    name = 'InitSchema1762266831614'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."exercise_equipment_enum" AS ENUM('bodyweight', 'assisted_body_weight', 'barbell', 'dumbbell', 'ez_bar', 'kettlebell', 'cable', 'machine', 'band', 'resistance_band', 'medicine_ball', 'cardio_machine', 'other')`);
        await queryRunner.query(`CREATE TYPE "public"."exercise_muscle_group_enum" AS ENUM('neck', 'arms', 'biceps', 'triceps', 'chest', 'shoulders', 'core', 'back', 'abdominals', 'obliques', 'legs', 'glutes', 'quadriceps', 'hamstrings', 'calves', 'full_body', 'other')`);
        ...
        await queryRunner.query(`CREATE TABLE "workout" ("id" SERIAL NOT NULL, "name" character varying, "order" integer, "day_of_week" "public"."workout_day_of_week_enum", "plan_id" integer, "user_id" integer NOT NULL, "created_by" integer, CONSTRAINT "PK_ea37ec052825688082b19f0d939" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "workout" ADD CONSTRAINT "FK_aea7bdb578979ab3fd974331f5c" FOREIGN KEY ("plan_id") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "workout" DROP CONSTRAINT "FK_aea7bdb578979ab3fd974331f5c"`);
